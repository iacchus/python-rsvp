...
Welcome to ``rsvp`` contributor's guide.
...
If you experience bugs or general issues with ``rsvp``, please have a look
...
You can help improve ``rsvp`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``rsvp`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``rsvp``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n rsvp python=3 six virtualenv pytest pytest-cov
    conda activate rsvp
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/rsvp.git
    cd rsvp
...
#. Install |pre-commit|_::
   ...
   ``rsvp`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/rsvp
.. _issue tracker: https://github.com/<USERNAME>/rsvp/issues
.. <-- end -->
